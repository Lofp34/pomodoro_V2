...
export const PauseIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M6.75 5.25a.75.75 0 0 1 .75.75V18a.75.75 0 0 1-1.5 0V6a.75.75 0 0 1 .75-.75Zm7.5 0a.75.75 0 0 1 .75.75V18a.75.75 0 0 1-1.5 0V6a.75.75 0 0 1 .75-.75Z" clipRule="evenodd" />
  </svg>
);
...
export const ResetIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M4.755 10.059a7.5 7.5 0 0 1 12.548-3.364l1.903 1.903h-4.518V4.5L16.48 2.25H18a9.75 9.75 0 0 1-1.705 6.495A9.76 9.76 0 0 1 12.001 21a9.753 9.753 0 0 1-8.39-4.523L5.601 13.951a7.5 7.5 0 0 1-.846-3.892Zm14.49 3.892a7.5 7.5 0 0 1-12.548 3.364l-1.903-1.903h4.518v4.5l-1.732 2.25h-1.532a9.75 9.75 0 0 1 1.705-6.495A9.76 9.76 0 0 1 11.999 3a9.753 9.753 0 0 1 8.39 4.523l-1.902 2.53a7.5 7.5 0 0 1 .846 3.892Z" clipRule="evenodd" />
  </svg>
);
...
export const ExportIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const EditIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
    <path d="M13.586 3.586a2 2 0 1 1 2.828 2.828l-.793.793-2.828-2.828.793-.793ZM11.379 5.793l.707-.707 2.828 2.828-.707.707L11.379 5.793Z" />
    <path d="M2 10v-.5A3.5 3.5 0 0 1 5.5 6H9v1.571A3.504 3.504 0 0 0 10.571 11H14.5a3.5 3.5 0 0 1 3.5 3.5V18a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-2.5A3.5 3.5 0 0 1 5.5 10H8v1.571A3.504 3.504 0 0 0 9.571 15H13.5a3.5 3.5 0 0 1 3.5-3.5V10A2.5 2.5 0 0 0 14.5 7.5h-1.625A2.5 2.5 0 0 0 10.375 10H2Z" />
 </svg>
);
